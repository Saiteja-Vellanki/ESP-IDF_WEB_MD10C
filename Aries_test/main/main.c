...
#define MOTOR_GRIPPER_MAX_ANGLE      180 
...
static void pwm_init(void)
{
   printf("Aries :::Configuring Initial Parameters of pwm......\n");
    ...
    pwm_config.frequency = 1000;    //frequency = 1000Hz, i.e. for every servo motor time period should be 20ms
